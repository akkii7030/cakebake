...
export const ProductDetails = () => {
  ...
  const { data: product, error, isLoading } = useDetailedProductQuery(productId, {
    skip: !productId
  });
            ...
            <div className="product-info">
              ...
              <div className="product-buttons">
                <button
                  ...
                  onClick={ access_token ? () => handleAddToCart(): () => window.location.href = '/login'}
